...
# Initialisation unique du bus I2C
try:
...
def set_mcp23017_pin_state(pin_number: int, state: bool) -> Result[bool, str]:
    """
    Contrôle l'état d'un pin sur le MCP23017.

    :param pin_number: Numéro du pin (0-15) sur le MCP23017.
    :param state: État désiré (True pour 'On', False pour 'Off').
    """
    if mcp is None:
